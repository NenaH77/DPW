...
class MovieInfo(object):
    def __init__(self):
        self.url = "http://api.rottentomatoes.com/api/public/v1.0/movies/" #url from where the information will be requested
        self.params = "?apikey=3wgzeuyj3ttnqnjbfr5xgafx"


    def send_info(self):
        full_url = self.url + self.params
